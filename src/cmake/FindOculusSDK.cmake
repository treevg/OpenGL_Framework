...
IF (DEFINED ENV{OCULUSSDK_ROOT})
    SET(OCULUSSDK_ROOT "$ENV{OCULUSSDK_ROOT}")
ENDIF()
SET(OCULUSSDK_ROOT
    "${OCULUSSDK_ROOT}"
    CACHE
...
SET(_OCULUS_SDK_LICENSE_FILE "${OCULUSSDK_ROOT}/LICENSE.txt")
