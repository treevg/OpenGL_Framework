...
void main() {
    // model size is found at instance_positionAttribute.w, resize it according to input
    ...
    eye_pos = view * vec4(instance_positionAttribute.xyz, 1) + positionAttribute * vec4(size/2, size/2, 1, 1);
